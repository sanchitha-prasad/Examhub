...
@Component({
  selector: 'app-corectanswers',
  templateUrl: './corectanswers.component.html',
  styleUrls: ['./corectanswers.component.css'],
})
export class CorectanswersComponent implements OnInit {
  data: any;
  subQuiz: any;
  quiz: any;
  le: any;
