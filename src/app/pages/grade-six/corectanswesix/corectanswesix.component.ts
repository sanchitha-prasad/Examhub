...
@Component({
  selector: 'app-corectanswesix',
  templateUrl: './corectanswesix.component.html',
  styleUrls: ['./corectanswesix.component.css'],
})
export class CorectanswesixComponent implements OnInit {
  data: any;
  subQuiz: any;
  quiz: any;
  le: any;
